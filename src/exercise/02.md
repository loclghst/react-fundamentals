...
`React.createElement('tagName', { props }, children1, children2, ...);`

// key prop not required with this syntax

`React.createElement('tagName', { props, children:[children1, children2] });`

// key prop is required if children is passed as an array in the props object.

Once elements are created, they are rendered onto the DOM using

`ReactDOM.render('elementToRender', domNodeWhereToRender)`
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=02%3A%20Intro%20to%20raw%20React%20APIs&em=loclghst%40gmail.com).

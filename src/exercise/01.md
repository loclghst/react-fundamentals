...
Using JS to create and set HTML elements

document.createElement('div');

document.body.append(<ele/>); document.setClassName('ClassName');
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=01%3A%20Basic%20JavaScript-rendered%20Hello%20World&em=loclghst%40gmail.com).
